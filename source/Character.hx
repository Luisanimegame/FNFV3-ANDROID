				...
				for (i in 0...charFileParams.length) {
					...
					switch (line[0]) {
						...
						case 'anim':
							...
							animation.addByPrefix(line[1], line[2], Std.int(Std.parseFloat(line[3])), loopa, flipXa, flipYa);
						case 'offset':
						...
						case 'flipY':
							flipY = true;
						case 'size':
							setGraphicSize(Std.int(Std.parseFloat(line[1])), Std.int(Std.parseFloat(line[2])));
					}
				}
